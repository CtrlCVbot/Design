...
stateDiagram-v2
    [*] --> Assigned: 배차 확정
    Assigned --> DriverConfirmed: 차주 확인
    DriverConfirmed --> PickupDone: 상차완료
    ...
    DriverConfirmed --> IssueHold: 운행 이슈
...
| `driver_confirmed` | 운행 준비 | 상차완료 | 차주 확인 완료 |
