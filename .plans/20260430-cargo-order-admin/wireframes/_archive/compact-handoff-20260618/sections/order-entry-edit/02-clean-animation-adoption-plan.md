...
| 구분 | 파일 | 역할 |
| --- | --- | --- |
| 애니메이션 기준 | `../../results/wireframe/order-register-new2.0/Cargo Order B Implementation Clean.html` | 기존 동작/모션 기준 |
| 반영 대상 | `../../results/html/화물 오더 접수수정 (오프라인).html` | 신규 HiFi 시각 기준본 |
| 로컬 후보 | `../../results/html/cargo-order-hifi-local-motion-20260616.html` | 기존 HiFi에 local motion layer를 주입한 개선 후보 |
...
상세 로그는 `../../artifact-audit/local-hifi-improvement-log-2026-06-16.md`에 기록했다.
...
상세 확인은 `../../artifact-audit/hifi-source-regeneration-check-2026-06-16.md`에 기록했다.
