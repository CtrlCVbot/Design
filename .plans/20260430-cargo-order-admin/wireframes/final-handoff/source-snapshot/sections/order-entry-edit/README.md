...
| 기준 | 역할 |
| --- | --- |
| `../../_archive/compact-handoff-20260618/results/html/화물 오더 접수수정 (오프라인).html` | 시각 고도화 기준 |
| `../reference-snapshot/wireframe/Cargo Order B Implementation Clean.html` | interaction/data hook 기준 |
| `../reference-snapshot/wireframe/Cargo Order Wireframe B Original Tone.html` | 기존 구조와 업무 액션 기준 |
