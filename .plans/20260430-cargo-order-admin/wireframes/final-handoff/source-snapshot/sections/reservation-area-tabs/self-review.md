...
| shadcn 기준 예약 영역 탭 HTML 후보 생성 | `../../_archive/compact-handoff-20260618/results/html/cargo-order-hifi-reservation-tabs-shadcn-20260616.html`, `README.md`, `self-review.md` |
| 최신 기획 기준 HTML 후보 갱신 | `../../_archive/compact-handoff-20260618/results/html/cargo-order-hifi-reservation-tabs-shadcn-20260616.html`, `README.md`, `self-review.md` |
...
| 금액 로그 명세서형 표시 + 상세 항목 펼침 기준 반영 | `01-reservation-tabs-planning.md`, `04-tab-amount-log-section.md`, `05-state-and-interaction-matrix.md`, `06-design-system-component-mapping.md`, `../../_archive/compact-handoff-20260618/results/html/cargo-order-hifi-reservation-tabs-shadcn-20260616.html` |
