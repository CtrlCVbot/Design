...
$sourceFixtureRoot = Join-Path (Split-Path -Parent $phaseRoot) 'phase4b-gt04-v2-1/fixture'
...
$tests = @(
    @{ Name = 'fixture integrity'; Action = { Assert-Condition (($fixtureBefore -join "`n") -eq ($sourceFixture -join "`n")) 'v2.2 fixture is not byte-identical to v2.1 fixture.' } },
