[WORKER BRIEF]
brief_id: GT04-v2-2-trial-01-diagnostic
role: routine_worker
...
known_context:
- repo root: C:/Work/Dev/Design/.plans/20260710-codex-gpt56-advisor-worker/phase4b-gt04-v2-2/fixture
- repo state: disposable fixture GT04-json-normalization-v2-2-live-shell; trial-01 is byte-identical to baseline and initially has 4 byte mismatches
...
allowed_paths:
- C:/Work/Dev/Design/.plans/20260710-codex-gpt56-advisor-worker/phase4b-gt04-v2-2/fixture/trial-01/records/*.json
forbidden_paths:
- baseline/**
- expected/**
- verifier-pass/**
