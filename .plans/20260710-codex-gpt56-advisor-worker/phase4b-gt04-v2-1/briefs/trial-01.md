[WORKER BRIEF]
brief_id: GT04-v2-1-trial-01-diagnostic
role: routine_worker
...
why:
- Verify custom Luna execution after replacing raw multiline JavaScript interpolation with structured read.output transport.
known_context:
- repo root: C:/Work/Dev/Design/.plans/20260710-codex-gpt56-advisor-worker/phase4b-gt04-v2-1/fixture
- repo state: disposable fixture GT04-json-normalization-v2-1-transport; trial-01 is byte-identical to the immutable baseline and initially has 4 byte mismatches
- current behavior: verify_gt04.ps1 reports trial-01 FAIL with mismatches 4; test_verify_gt04.ps1 reports PASS with tests 5
- architecture decision: apply the seven fixed mechanical rules only to assigned JSON; acceptance runs in the current Windows PowerShell process and compares exact expected bytes
...
allowed_paths:
- C:/Work/Dev/Design/.plans/20260710-codex-gpt56-advisor-worker/phase4b-gt04-v2-1/fixture/trial-01/records/*.json
forbidden_paths:
- baseline/**
- expected/**
- verifier-pass/**
...
- EVAL, briefs, manifests, transport files, v1/v2 evidence, global .codex/.agents files, and unrelated user WIP
workspace_isolation:
